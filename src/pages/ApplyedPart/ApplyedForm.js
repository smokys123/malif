...
class ApplyedForm extends Component {
  constructor(props) {
    super(props);
  ...
  getEventApi = () => {
    ...
    data.append('eid',eid)
    return axios.post('http://54.180.25.155:8020/apply/participant/info',data)
  ...
  _handleSubmit(e) {
    ...
    data.append('uid',_id)
    axios.post('http://54.180.25.155:8020/modify/participant', data)
          ...
          {this.state.Event && this.state.Event.map((event) => (
            ...
            <div className="form-group">
              ...
              <div className="col-sm-9">
                <input className="" onChange={this.handleUserName}  placeholder={event.pname}/> 
              </div>
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <div className="form-group">
                ...
                <div className="col-sm-9">
                   <input className="" onChange={this.handelCompanyNum} placeholder={event.partner}/> 
                </div>
              </div>
              <div className="form-group">
